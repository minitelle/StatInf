...
dtresults
```
_Conclusion:_ from the summary table, we can see that the Sample variance `r sample_var` is pretty close to th theoretical variance of `r theoretical_var`.
